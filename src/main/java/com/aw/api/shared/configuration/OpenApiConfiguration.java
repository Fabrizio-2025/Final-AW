package com.aw.api.shared.configuration;
...
public class OpenApiConfiguration {
    ...
    public Project project() {
        return new Project("Arquitectura de Aplicaciones Web - EB", "This Project was done for the Web Application Architecture final exam.", "https://github.com/Fabrizio-2025", "Life-Travel");
    }
